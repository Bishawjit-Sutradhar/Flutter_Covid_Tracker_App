...
import 'package:flutter_covid_19_tracker_app/View/countries_list.dart';
                      ...
                      children: [
                        PieChart(
                          dataMap:{
                            ...
                            "Daths":double.parse(snapshot.data!.deaths!.toString())
                          },
                          ...
                          child: Card(
                            child: Column(
                              children: [
                                ...
                                ReusableRow(title: 'Today Daths', value:snapshot.data!.todayDeaths.toString()),
                        ...
                        GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (contex)=>CountriesListScreen()));
                          },
                          child: Container(
                            height: 50,
